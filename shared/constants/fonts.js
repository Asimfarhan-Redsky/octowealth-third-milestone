...
export const spacings = {
  ...
  xLarge: normalizeText(baseSpacing * 2.5), //10
  ...
  Large2x: normalizeText(baseSpacing * 5), // 20
  ExtraLarge: normalizeText(baseSpacing * 6),
  ExtraLargex: normalizeText(baseSpacing * 7),
  ExtraLarge1x: normalizeText(baseSpacing * 7.5), //30
  ExtraLarge2x: normalizeText(baseSpacing * 8),
  ExtraLarge3x: normalizeText(baseSpacing * 9),
  ExtraLarge4x: normalizeText(baseSpacing * 10), //40
  ExtraLarge5x: normalizeText(baseSpacing * 12.5), //50
};
